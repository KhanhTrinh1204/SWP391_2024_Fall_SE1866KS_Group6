...
public class HotelDAO extends DbContext<Hotel>{
    ...
    public ArrayList<Hotel> getHotel() {
        ...
        String sql = "select hotel_id, hotel_name, description from hotel";
        try {
     ...
     public void addHotel(Hotel hotel) {
        String sql = "INSERT INTO hotel (hotel_name, img_url, description, start_date, end_date, travel_agent_id, active, price)"
                + " VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
     ...
     public boolean updateHotel(Hotel hotel) {
        ...
        try (PreparedStatement stm = connection.prepareStatement(sql)) {
            ...
            stm.setDouble(6, hotel.getPrice());
