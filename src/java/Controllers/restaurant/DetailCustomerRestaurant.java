 ...
 * @author hoang
 */
@WebServlet(name = "DetailCustomerRestaurant", urlPatterns = {"/DetailCustomerRestaurant"})
public class DetailCustomerRestaurant extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String hotelIDStr = request.getParameter("id");
            try {
                ...
                RestaurantDao hotelDAO = new RestaurantDao();
                Restaurant restaurant = hotelDAO.GetRestaurantById(hotelId);
                if (restaurant != null) {
                    // Gửi dữ liệu vehicle tới trang JSP để hiển thị
                    request.setAttribute("restaurant", restaurant);
                    request.getRequestDispatcher("view/RestaurantDetail.jsp").forward(request, response);
                } else {
