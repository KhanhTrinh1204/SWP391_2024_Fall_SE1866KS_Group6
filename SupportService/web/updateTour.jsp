...
<body>
    ...
    <c:if test="${not empty tour}">
        <form action="update" method="POST">
            ...
            <input type="text" id="categoryName" name="categoryName" value="${tour.categoryTour.categoryName}" required><br><br>
            
            <label for="endDate">Restaurant:</label>
            <input type="text" id="restaurantName" name="restaurantName" value="${tour.vehicle.vehicleName}" required><br><br>
            
            <label for="endDate">Vehicle:</label>
            <input type="text" id="vehicleName" name="vehicleName" value="${tour.restaurant.restaurantName}" required><br><br>
