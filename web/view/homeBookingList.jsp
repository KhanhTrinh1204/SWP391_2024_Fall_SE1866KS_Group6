...
<section class="home" id="home">
    ...
    <h1 style="text-align: center; color: red; margin: auto; font-size: 25px;">My booking tour</h1>
<section >
    <c:if test="${tour != null}">
        <div class="tour-container">
            ...
            <c:forEach var="tour" items="${tour}" varStatus="status">
                <div class="tour-item">
                    ...
                    <div><fmt:formatNumber value="${tour.price}" type="currency" currencySymbol="$"/></div>
                    
                    
                    <div>
                        <img src="${tour.image}" alt="Tour Image" style="width: 100px; height: auto;">
                    </div>
                      <div>${tour.userBooking[0].timebooking}</div>
                    <div>
                       
                        <c:if test="${tour.userBooking[0].status == '1'}">
                        <a href="#" onclick="updateTour('${tour.userBooking[0].id}')">
                            
                            <i class="fas fa-trash-alt"></i>
                        </a>
                        </c:if>
                        <c:if test="${tour.userBooking[0].status == '3'}">
                          Canceled
                        </c:if>
                          <c:if test="${tour.userBooking[0].status == '2'}">
                          Completed
                        </c:if>
                    </div>
                </div>
...
<style>
    ...
    .tour-item div:nth-child(1),
    .tour-header div:nth-child(1) {
        width: 50px;
    }
