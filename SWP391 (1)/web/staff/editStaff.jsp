...
<div class="wrapper">
    ...
    <div class="container-fluid">
        ...
        <input type="text" name="fullName" id="fullName" value="${staff.fullName}" required><br><br>

        <label for="location">Email:</label>
        <input type="text" name="email" id="email" value="${staff.email}" required><br><br>


        <label for="phoneNumber">Phone Number:</label>
        <input type="text" name="phoneNumber" id="phoneNumber" value="${staff.phoneNumber}" required><br><br>


        <label for="category">Address:</label>
        <input type="text" name="address" id="address" value="${staff.address}" required><br><br>

        <label for="status">Status:</label>
        <select name="status" id="status">
            <option value="true" <c:if test="${res.status}">selected</c:if>>Active</option>
            <option value="false" <c:if test="${not res.status}">selected</c:if>>De-Active</option>
        </select><br><br>
