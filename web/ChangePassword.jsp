    ...
    <body>
        <div class="container" id="container">
            <div class="form-container sign-in-container">
                <form action="ChangePasswordControl" method="post" onsubmit="return validateChangePasswordForm()">
                    <h1>Change password</h1>
                    <input type="password"  id="oldpass" name="oldpass" placeholder="Old-Password"></input>
