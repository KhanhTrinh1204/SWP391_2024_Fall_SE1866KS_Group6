...
public class EditRestaurant extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditRestaurant</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditRestaurant at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String vehicleIdStr = request.getParameter("id");
            try {
                int restaurantID = Integer.parseInt(vehicleIdStr);
                ...
                request.setAttribute("error", "Invalid RestaurantID");
                request.getRequestDispatcher("error.jsp").forward(request, response);
            }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean status = Boolean.parseBoolean(request.getParameter("status"));
            ...
            Restaurant res = new Restaurant(restaurantId, restaurantName, location, description, phoneNumber, email, category, status, image);
