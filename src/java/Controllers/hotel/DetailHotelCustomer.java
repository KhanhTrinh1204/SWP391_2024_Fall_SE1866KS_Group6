 ...
 * @author hoang
 */
@WebServlet(name = "DetailHotelCustomer", urlPatterns = {"/DetailHotelCustomer"})
public class DetailHotelCustomer extends HttpServlet {
       ...
       String hotelIDStr = request.getParameter("id");
            try {
                ...
                if (hotel != null) {
                    ...
                    request.getRequestDispatcher("view/HotelDetail.jsp").forward(request, response);
                } else {
