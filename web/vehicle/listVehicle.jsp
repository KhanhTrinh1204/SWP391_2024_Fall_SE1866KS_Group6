...
<html lang="en">
      <head>
        ...
        <title>Management vehicle</title>
            ...
            <br>
                ...
                <div class="main-content">
                                ...
                                <div class="table-title">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                                            <a href="<%=request.getContextPath()%>/vehicle/add" class="btn btn-success" data-toggle="modal">
                                                <i class="material-icons">&#xE147;</i> <span>Add New Vehicle</span></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <c:forEach items="${vehicle}" var="v" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>
                                                         <a href="#" onclick="deleteStaff('${v.vehicleId}')">   <i class="material-icons">deletes </i></a> 
                                                            <a href="<%=request.getContextPath()%>/vehicle/edit?id=${v.vehicleId}"><i class="material-icons">inbox</i></a>
                                                        <a href="<%=request.getContextPath()%>/vehicle/detail?id=${v.vehicleId}"><i class="material-icons">details</i></a> &nbsp;
                    ...
                    <c:if test="${currentPage > 1}">
                        <a href="${pageContext.request.contextPath}/vehicle/list?page=${currentPage - 1}&search=${param.search}" class="btn btn-light">Previous</a>
                    </c:if>
                    <c:if test="${currentPage < totalPages}">
                        <a href="${pageContext.request.contextPath}/vehicle/list?page=${currentPage + 1}&search=${param.search}" class="btn btn-light">Next</a>
                         </c:if>
                </div>
